<form id="editAccountForm" method="POST" action="{{ strpos(request()->path(), 'admin') !== false ? route('admin.updateAccount', $account->id) : route('moderator.updateAccount', $account->id) }}">
