                    ...
                    <div class="filter-post">
                        ...
                        >
                            ...
                            >
                                ...
                                <option
                                    value="following"
                                    {{ request('filter') == 'following' ? 'selected' : '' }}
                                >
                                    Following
                                </option>
                            </select>
                                                ...
                                                @if (Auth::user()->user_id != $post->user->user_id)
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            type="hidden"
                                                            name="following"
                                                            value="{{ $post->user->user_id }}"
                                                        />

                                                        <button
                                                            class="follow-btn {{ $haveFollowed ? 'following' : '' }}"
                                                        >
                                        ...
                                        <div class="comment-area">
                                            @foreach ($post->comments as $comment)
                                                <div class="user-comment">
                                                    <div>
                                                        <img
                                                            src="{{ $comment->user->userPhoto ? Storage::url($comment->user->userPhoto) : '../imgs/user-img.png' }}"
                                                    ...
                                                    >
                                                        <span>
                                                            <a
                                                                href="{{ Auth::check() && Auth::user()->user_id == $comment->user->user_id ? route('profile') : route('visit-profile', ['user_id' => $comment->user->user_id]) }}"
                                                            >
                                                            ...
                                                            @if ($comment->user->accountType === 'Attorney')
                                                                <i
                                                                    class="fa-regular fa-star rate-btn"
                                                        ...
                                                        >
                                                            ...
                                                            @else
                                                                <form
                                                                    action="{{ route('users.createReply') }}"
                                                                    method="POST"
                                                                >
                                                                    @csrf
                                                                    <textarea
                                                                        ...
                                                                        placeholder="Replying to {{ $comment->user ? $comment->user->firstName : 'Unknown User' }}"
                                                                    ></textarea>
                                                                    <input
                                                                        type="hidden"
                                                                        name="post_id"
                                                ...
                                                >
                                                    @foreach ($comment->reply as $reply)
                                                        <div class="user-reply">
                                                            <div>
                                                                <img
                                                                    src="{{ $reply->user->userPhoto ? Storage::url($reply->user->userPhoto) : '../imgs/user-img.png' }}"
                                                                    alt="User Profile Picture"
                                                                    class="user-profile-photo"
                                                                />
                                                            </div>
                                                            <div
                                                                class="user-reply-content"
                                                            >
                                                                <span>
                                                                    <a
                                                                        href="{{ Auth::check() && Auth::user()->user_id == $reply->user->user_id ? route('profile') : route('visit-profile', ['user_id' => $reply->user->user_id]) }}"
                                                                    >
                                                                ...
                                                                <label>
                                                                    replied to
                                                                    <span>
                                                                        {{ $comment->user ? $comment->user->firstName : 'Unknown User' }}
                                                                    </span>
                                                                    's comment.
                                                                </label>
                                                                <p>
                                        ...
                                        >
                                            ...
                                            @else
                                                <form
                                                    id="commentForm"
                                                    method="POST"
                                                    action="{{ route('users.createComment') }}"
                                                >
                                                    @csrf
                                                    <img
