          ...
          <div class="forum-left">
            <div class="forum-overview">
              <section class="forum-section">
                <div class="circle">
                  <img class="images" src="../imgs/pic-sample.png" alt="Image 1"/>
                </div>
    ...
    <div id="postModal" class="post-modal">
      <div class="post-modal-content">
        ...
        <div class="post-modal-footer">
          ...
          <p>
            Note: The post will be reviewed first prior to the approval of the
            moderators to make sure that it follows a certain measure of
            decency.
          </p>
