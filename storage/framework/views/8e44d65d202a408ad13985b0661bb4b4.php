...
<div id="filterModal" class="modal">
    <div class="modal-content">
        ...
        <form
            id="filterForm"
            method="GET"
            action="<?php echo e(route('admin.forums.filter')); ?>"
        >
...
<?php /**PATH C:\xampp\htdocs\lawminary_laravel\resources\views/includes_forums/forums_filter_inc.blade.php ENDPATH**/ ?>