...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/moderator/mrecourcesstyle.css')); ?>">
            ...
            <header>
                ...
                <div id="addModal" class="modal">
                    <div class="modal-content">
                        ...
                        <form id="resourceForm" enctype="multipart/form-data" method="post" action="<?php echo e(route('moderator.uploadResource')); ?>">
                            <?php echo csrf_field(); ?>
            ...
            <content>
                <div class="table">
                    <table class="resource-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $rsrcfiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rsrcfile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($rsrcfile->id); ?></td>
                                <td><?php echo e($rsrcfile->documentTitle); ?></td>
                                <td><?php echo e($rsrcfile->documentDesc); ?></td>
                                <td><?php echo e($rsrcfile->documentFile); ?></td>
                                <td><?php echo e($rsrcfile->created_at); ?></td>
                                <td>
                                    <button type="button" class="custom-button view-button" 
                                    data-id="<?php echo e($rsrcfile->id); ?>" 
                                    data-title="<?php echo e($rsrcfile->documentTitle); ?>" 
                                    data-desc="<?php echo e($rsrcfile->documentDesc); ?>" 
                                    data-file="<?php echo e($rsrcfile->documentFile); ?>" 
                                    data-date="<?php echo e($rsrcfile->created_at); ?>"
                                    >View</button>
                                    <form method="post" action="<?php echo e(route('moderator.destroyResource', ['rsrcfile' => $rsrcfile])); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\lawminary_laravel\resources\views\moderator\mresources.blade.php ENDPATH**/ ?>