...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/systemcontentstyle.css')); ?>">
            ...
            <div class="top-nav">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="/admin/systemcontent" class="current"><i class="fa-solid fa-display"></i><span>System Content</span></a></li>
                    </ul>
                </nav>
            </div>
