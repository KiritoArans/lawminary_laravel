...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/admod_login_style.css')); ?>">
...
<body>
    <content>
        <div class="login-container">
            ...
            <h1>Login</h1>
            <form action="<?php echo e(route('loginAdMod')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\lawminary_laravel\resources\views\admin\admod_login.blade.php ENDPATH**/ ?>