...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/moderator/mdashboardstyle.css')); ?>">
...
<body>
    <div class="container">
        <aside>
            <div class="top-nav">
                ...
                <nav>
                      <ul>
                        <li><a href="/moderator/dashboard"  class="current"><i class="fa-solid fa-chart-pie"></i><span>Dashboard</span></a></li>
    ...
    <script src="<?php echo e(asset('js/moderator_js/mdashboard_js.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\lawminary_laravel\resources\views\moderator\mdashboard.blade.php ENDPATH**/ ?>