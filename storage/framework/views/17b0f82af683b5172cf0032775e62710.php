        ...
        <div class="container">
            ...
            <main>
                ...
                <content class="about-content">
                    <?php echo $__env->make('includes_syscon.about_pao_inc', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </content>
            </main>
        </div>
...
<?php /**PATH C:\xampp\htdocs\lawminary_laravel\resources\views/settings/about_pao.blade.php ENDPATH**/ ?>