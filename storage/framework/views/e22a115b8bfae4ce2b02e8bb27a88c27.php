...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="<?php echo e(asset('css/admin/systemcontentstyle.css')); ?>"
        />
            ...
            <main>
                <header>
                    <div class="header-top">
                        <img
                            src="<?php echo e(Storage::url($sysconData->first()->logo_path)); ?>"
                            alt=""
                        />
                ...
                <content class="table-container">
                    ...
                    <?php echo $__env->make('includes_syscon.syscon_table_inc', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </content>
            </main>
        </div>
        <script src="<?php echo e(asset('js/admin_js/systemcontent_js.js')); ?>"></script>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\lawminary_laravel\resources\views/admin/systemcontent.blade.php ENDPATH**/ ?>