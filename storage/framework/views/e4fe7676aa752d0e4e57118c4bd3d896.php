...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/moderator/maccountsstyle.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/nav_style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/moderator/base_moderator_table_style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/moderator/base_moderator_modal_style.css')); ?>">
...
<body>
            ...
            <section class="filter-container">
                ...
                <div class="action-buttons">
                    ...
                    <div id="addModal" class="modal">
                        ...
                        <form id="addForm" method="POST" action="<?php echo e(route('moderator.addAccount')); ?>">
                            <?php echo csrf_field(); ?>
                            <?php if($errors->any()): ?>
                                <div class="error">
                                    <ul>
                            ...
                            <tbody id="accountTableBody">
                                ...
                                <tr>
                                    ...
                                    <div id="editAccountModal" class="modal">
                                        ...
                                        <!--delete button-->
                                        <form id="delete-form-<?php echo e($account->id); ?>" action="<?php echo e(route('maccounts.destroy', $account->id)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('js/moderator_js/maccounts_js.js')); ?>"></script>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\lawminary_laravel\resources\views\moderator\maccounts.blade.php ENDPATH**/ ?>